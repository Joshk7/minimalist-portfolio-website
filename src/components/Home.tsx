...
export default function Home() {
  return (
    <main className="pt-16 md:pt-24 lg:px-8">
      ...
      <section className="max-w-277.5 mx-auto py-20 md:py-12 px-8 flex flex-col gap-10 md:flex-row md:justify-between md:items-center lg:px-0">
        ...
        <NavLink
          to="/contact"
          className="flex-1 block mx-auto border border-slate-950 py-4 px-8 public-sans uppercase tracking-[0.165em] text-xs cursor-pointer hover:bg-slate-950 hover:text-white max-w-42"
        >
          Contact Me
        </NavLink>
      </section>
